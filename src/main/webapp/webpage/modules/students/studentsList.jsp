...
<head>
	...
	<%@include file="studentsList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">管理学生列表</h3>
	</div>
	...
	<div id="search-collapse" class="collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="students" class="form form-horizontal well clearfix">
	...
	<!-- 表格 -->
	<table id="studentsTable"   data-toolbar="#toolbar"></table>
