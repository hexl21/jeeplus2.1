...
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">文章信息列表</h3>
	</div>
	...
	<div id="search-collapse" class="collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="article" class="form form-horizontal well clearfix">
	...
	<!-- 表格 -->
	<table id="articleTable"   data-toolbar="#toolbar"></table>
