	...
	<script type="text/javascript">
		...
		function save() {
	            ...
	            if(!isValidate){
	                ...
	                jp.loading();
	                jp.post("${ctx}/car/carKind/save",$('#inputForm').serialize(),function(data){
	                    if(data.success){
		   ...
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						...
						title="父级编号" url="/car/carKind/treeData" extId="${carKind.id}" cssClass="form-control " allowClear="true"/>
					</td>
