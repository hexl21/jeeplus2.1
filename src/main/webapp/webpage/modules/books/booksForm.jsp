	...
	<script type="text/javascript">
		...
		function save() {
            ...
            if(!isValidate){
                ...
                jp.loading();
                jp.post("${ctx}/books/books/save",$('#inputForm').serialize(),function(data){
                    if(data.success){
		...
		<table class="table table-bordered">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<sys:fileUpload path="bookPic"  value="${books.bookPic}" type="file" uploadPath="/books/books"/>
					</td>
				...
				<tr>
					...
					<td class="width-35">
						<form:select path="state" class="form-control ">
							...
							<form:options items="${fns:getDictList('book_state')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
					</td>
