    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            if (!isValidate) {
                ...
                jp.loading();
                jp.post("${ctx}/weixin/wxMediaImage/save", $('#inputForm').serialize(), function (data) {
                    if (data.success) {
...
<form:form id="inputForm" modelAttribute="wxMediaFiles" class="form-horizontal">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <td class="width-15 active"><label class="pull-right"><font color="red">*</font>图片文件：</label></td>
            <td class="width-35">
