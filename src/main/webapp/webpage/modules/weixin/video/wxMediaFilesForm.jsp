    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            if (!isValidate) {
                ...
                jp.loading();
                jp.post("${ctx}/weixin/wxMediaVideo/save", $('#inputForm').serialize(), function (data) {
                    if (data.success) {
...
<form:form id="inputForm" modelAttribute="wxMediaFiles" class="form-horizontal">
    ...
    <table class="table table-bordered">
        <tbody>
        <tr>
            <td class="width-15"><label class="pull-right"><font color="red">*</font>标题：</label></td>
            <td class="width-35">
                <form:input path="title" htmlEscape="false" class="form-control required"/>
            </td>
        </tr>
        <tr>
            <td class="width-15"><label class="pull-right"><font color="red">*</font>简介说明：</label></td>
            <td class="width-35">
        ...
        <tr>
            <td class="width-15"><label class="pull-right"><font color="red">*</font>视频文件：</label></td>
            <td class="width-35">
                <input type="file" class="" accept="video/mp4" id="audioName" name="audioName"/><a
                    href="javascript:" onclick="audioNameFinder(1);"
                    class="btn btn-primary">上传视频</a><span id="fileMsg" color="red"></span></td>
        </tr>
        </tbody>
    </table>
</form:form>
