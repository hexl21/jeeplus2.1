    ...
    <script>
        $(document).ready(function () {
            $('#wxMediaFilesTable').bootstrapTable({
                ...
                url: "${ctx}/weixin/wxMediaVideo/dataSelect",
                ...
                columns: [{
                    ...
                    , {
                        ...
                        formatter: function (value, row, index) {
                            return '<a class="btn btn-primary btn-xs"  onclick="javascript:view(\'' + row.id + '\')"><i class="fa fa-video-camera"></i> 播放</a>';
                        }
                    }
                ]
        ...
        function view(id) {//没有权限时，不显示确定按钮
            ...
            jp.openViewDialog('查看视频', "${ctx}/weixin/wxMediaVideo/look?id=" + id, '800px', '650px');
        }
...
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">视频素材列表</h3>
        </div>
                ...
                <div class="accordion-inner">
                    <form:form id="searchForm" modelAttribute="wxMediaFiles" class="form form-horizontal well clearfix">
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <label class="label-item single-overflow pull-left" title="媒体类型：">媒体类型：</label>
                            <form:select path="mediaType" class="form-control m-b">
