...
<head>
	...
	<%@include file="wxFansTagMppingList.js" %>
</head>
<body>
				...
				<div class="col-sm-9 col-md-10 animated fadeInRight">
					...
					<div id="search-collapse" class="collapse">
						<div class="accordion-inner">
							<form:form id="searchForm" modelAttribute="wxFansTagMpping" class="form form-horizontal well clearfix">

								<input id="tagId" name="tagId" type="hidden" value="${wxFansTagMpping.tagId}"/>
					...
					<!-- 表格 -->
					<table id="wxFansTagMppingTable"   data-toolbar="#toolbar"></table>
