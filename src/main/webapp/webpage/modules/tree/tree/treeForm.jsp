	...
	<script type="text/javascript">
		...
		function save() {
            ...
            if(!isValidate){
                ...
                jp.loading();
                jp.post("${ctx}/tree/tree/tree/save",$('#inputForm').serialize(),function(data){
                    if(data.success){
		   ...
		   <tbody>
				<tr>
					...
					<td class="width-35">
						...
						title="父级编号" url="/tree/tree/tree/treeData" extId="${tree.id}" cssClass="form-control " allowClear="true"/>
					</td>
				<tr>
