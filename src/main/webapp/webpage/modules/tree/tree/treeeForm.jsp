	...
	<script type="text/javascript">
		...
		function save() {
            ...
            if(!isValidate){
                ...
                jp.loading();
                jp.post("${ctx}/tree/tree/treee/save",$('#inputForm').serialize(),function(data){
                    if(data.success){
...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="treee" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<table class="table table-bordered">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<sys:treeselect id="parent" name="parent.id" value="${treee.parent.id}" labelName="parent.name" labelValue="${treee.parent.name}"
						title="父级编号" url="/tree/tree/treee/treeData" extId="${treee.id}" cssClass="form-control " allowClear="true"/>
					</td>
				<tr>
