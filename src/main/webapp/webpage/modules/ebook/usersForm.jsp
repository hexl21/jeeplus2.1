    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            if (!isValidate) {
                ...
                jp.loading();
                jp.post("${ctx}/ebook/users/save", $('#inputForm').serialize(), function (data) {
                    if (data.success) {
...
<form:form id="inputForm" modelAttribute="users" class="form-horizontal">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td class="width-35">
                <sys:fileUpload path="portraitpic" value="${users.portraitpic}" type="file" uploadPath="/ebook/users"/>
            </td>
