    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            if (!isValidate) {
                ...
                jp.loading();
                jp.post("${ctx}/ebook/buychapter/save", $('#inputForm').serialize(), function (data) {
                    if (data.success) {
...
<body class="bg-white">
<form:form id="inputForm" modelAttribute="buychapter" class="form-horizontal">
    <form:hidden path="id"/>
    <table class="table table-bordered">
        ...
        <tr>
            <td class="width-15 active"><label class="pull-right">章节书币：</label></td>
            <td class="width-35">
                <form:input path="chaptermoney" htmlEscape="false" class="form-control "/>
            </td>
