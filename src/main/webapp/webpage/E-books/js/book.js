$(function () {
    ...
    $('.consu-ul ul').find('li').toggle(function () {
        $(this).attr("class", "on");
        $(this).find('img').attr('src', 'webpage/E-books/images/con-xia.png');
    }, function () {
        $(this).attr("class", "");
        $(this).find('img').attr('src', 'webpage/E-books/images/con-zuo.png');
    })
    /*个人中心--充值*/
    //点击“充值”--显示
    ...
    $('.book-aset').on('click', function () {
        $('.book-set').fadeIn();
        $(this).find('img').attr('src', 'webpage/E-books/images/book-b2.png');
    })
    ...
    $('.book-aday').toggle(function () {
        $(this).find('img').attr('src', 'webpage/E-books/images/book-c2.png');
        bookDay.innerHTML = "白天";
        $('.index-body').css('background', '#000');
    }, function () {
        $(this).find('img').attr('src', 'webpage/E-books/images/book-c3.png');
