...
public class WxMemoryCacheClient {
	...
	public static void addMpAccount(WxAccount account){
		Map<String,WxAccount> mpAccountMap = (Map<String, WxAccount>) CacheUtils.get("mpAccountMap");
...
//
	public static WxAccount getMpAccount(){
		Map<String,WxAccount> mpAccountMap = (Map<String, WxAccount>) CacheUtils.get("mpAccountMap");
		return mpAccountMap.get(getAccount());
	}

	public static WxAccount getMpAccount(String accout){
		Map<String,WxAccount> mpAccountMap = (Map<String, WxAccount>) CacheUtils.get("mpAccountMap");
