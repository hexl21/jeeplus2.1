...
public class WxApi {
    ...
    // 设置用户备注名
    public static final String updateremark = "https://api.weixin.qq.com/cgi-bin/user/info/updateremark?access_token=%s";
    ...
    //获取用户身上的标签列表
    public static final String getidlist_tags = "https://api.weixin.qq.com/cgi-bin/tags/getidlist?access_token=%s";
    ...
    //获取消息发送概况数据
    public static final String getupstreammsg = "https://api.weixin.qq.com/datacube/getupstreammsg?access_token=%s";

    // 获取消息分送分时数据（getupstreammsghour）	1	https://api.weixin.qq.com/datacube/getupstreammsghour?access_token=ACCESS_TOKEN
    public static final String getupstreammsghour = "https://api.weixin.qq.com/datacube/getupstreammsghour?access_token=%s";

    // 获取消息发送分布数据（getupstreammsgdist）	15	https://api.weixin.qq.com/datacube/getupstreammsgdist?access_token=ACCESS_TOKEN
    public static final String getupstreammsgdist = "https://api.weixin.qq.com/datacube/getupstreammsgdist?access_token=%s";
    ...
    public static final String getupstreammsgdistmonth = "https://api.weixin.qq.com/datacube/getupstreammsgdistmonth?access_token=%s";

    //   获取图文群发每日数据（getarticlesummary）	1	https://api.weixin.qq.com/datacube/getarticlesummary?access_token=ACCESS_TOKEN
    public static final String getarticlesummary = "https://api.weixin.qq.com/datacube/getarticlesummary?access_token=%s";

    //   获取图文群发总数据（getarticletotal）	1	https://api.weixin.qq.com/datacube/getarticletotal?access_token=ACCESS_TOKEN
    public static final String getarticletotal = "https://api.weixin.qq.com/datacube/getarticletotal?access_token=%s";

    //  获取图文统计数据（getuserread）	3	https://api.weixin.qq.com/datacube/getuserread?access_token=ACCESS_TOKEN
    public static final String getuserread = "https://api.weixin.qq.com/datacube/getuserread?access_token=%s";

    //  获取图文统计分时数据（getuserreadhour）	1	https://api.weixin.qq.com/datacube/getuserreadhour?access_token=ACCESS_TOKEN
    public static final String getuserreadhour = "https://api.weixin.qq.com/datacube/getuserreadhour?access_token=%s";

    //  获取图文分享转发数据（getusershare）	7	https://api.weixin.qq.com/datacube/getusershare?access_token=ACCESS_TOKEN
    public static final String getusershare = "https://api.weixin.qq.com/datacube/getusershare?access_token=%s";

    // 获取图文分享转发分时数据（getusersharehour）	1	https://api.weixin.qq.com/datacube/getusersharehour?access_token=ACCESS_TOKEN
    public static final String getusersharehour = "https://api.weixin.qq.com/datacube/getusersharehour?access_token=%s";
    ...
    public static JSONObject updateremark(String token, String params) throws WxErrorException {
        ...
        String result = HttpClientUtils.sendHttpPost(String.format(updateremark, token), params);
        WxError wxError = WxError.fromJson(result);
        if (wxError.getErrorCode() != 0) {
            throw new WxErrorException(wxError);
        }
    ...
    public static JSONObject getidlist_tags(String token, String params) throws WxErrorException {
        String result = HttpClientUtils.sendHttpPost(String.format(getidlist_tags, token), params);
        WxError wxError = WxError.fromJson(result);
        if (wxError.getErrorCode() != 0) {
            throw new WxErrorException(wxError);
        }
    ...
    //获取消息发送概况数据
    public static JSONObject getupstreammsg(String token, String params) throws WxErrorException {
        String result = HttpClientUtils.sendHttpPost(String.format(getupstreammsg, token), params);
        WxError wxError = WxError.fromJson(result);
        if (wxError.getErrorCode() != 0) {
            throw new WxErrorException(wxError);
        }
    ...
    //获取消息分送分时数据
    public static JSONObject getupstreammsghour(String token, String params) throws WxErrorException {
        String result = HttpClientUtils.sendHttpPost(String.format(getupstreammsghour, token), params);
        WxError wxError = WxError.fromJson(result);
        if (wxError.getErrorCode() != 0) {
            throw new WxErrorException(wxError);
        }
    ...
    //获取消息发送分布数据
    public static JSONObject getupstreammsgdist(String token, String params) throws WxErrorException {
        String result = HttpClientUtils.sendHttpPost(String.format(getupstreammsgdist, token), params);
        WxError wxError = WxError.fromJson(result);
        if (wxError.getErrorCode() != 0) {
            throw new WxErrorException(wxError);
        }
    ...
    //获取消息发送分布月数据
    public static JSONObject getupstreammsgdistmonth(String token, String params) throws WxErrorException {
        String result = HttpClientUtils.sendHttpPost(String.format(getupstreammsgdistmonth, token), params);
        WxError wxError = WxError.fromJson(result);
        if (wxError.getErrorCode() != 0) {
            throw new WxErrorException(wxError);
        }
    ...
    //获取图文群发每日数据
    public static JSONObject getarticlesummary(String token, String params) throws WxErrorException {
        String result = HttpClientUtils.sendHttpPost(String.format(getarticlesummary, token), params);
        WxError wxError = WxError.fromJson(result);
        if (wxError.getErrorCode() != 0) {
            throw new WxErrorException(wxError);
        }
    ...
    //获取图文群发总数据
    public static JSONObject getarticletotal(String token, String params) throws WxErrorException {
        String result = HttpClientUtils.sendHttpPost(String.format(getupstreammsgdistmonth, token), params);
        WxError wxError = WxError.fromJson(result);
        if (wxError.getErrorCode() != 0) {
            throw new WxErrorException(wxError);
    ...
    //获取图文统计数据
    public static JSONObject getuserread(String token, String params) throws WxErrorException {
        String result = HttpClientUtils.sendHttpPost(String.format(getuserread, token), params);
        WxError wxError = WxError.fromJson(result);
        if (wxError.getErrorCode() != 0) {
            throw new WxErrorException(wxError);
        }
    ...
    //获取图文统计分时数据
    public static JSONObject getuserreadhour(String token, String params) throws WxErrorException {
        String result = HttpClientUtils.sendHttpPost(String.format(getuserreadhour, token), params);
        WxError wxError = WxError.fromJson(result);
        if (wxError.getErrorCode() != 0) {
            throw new WxErrorException(wxError);
        }
    ...
    //获取图文分享转发数据
    public static JSONObject getusershare(String token, String params) throws WxErrorException {
        String result = HttpClientUtils.sendHttpPost(String.format(getusershare, token), params);
        WxError wxError = WxError.fromJson(result);
        if (wxError.getErrorCode() != 0) {
            throw new WxErrorException(wxError);
        }
    ...
    //获取图文分享转发分时数据
    public static JSONObject getusersharehour(String token, String params) throws WxErrorException {
        String result = HttpClientUtils.sendHttpPost(String.format(getusersharehour, token), params);
        WxError wxError = WxError.fromJson(result);
        if (wxError.getErrorCode() != 0) {
            throw new WxErrorException(wxError);
        }
