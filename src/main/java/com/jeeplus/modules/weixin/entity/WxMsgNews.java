...
public class WxMsgNews extends DataEntity<WxMsgNews> {
    ...
    private List<WxMsgNewsArticle> articleList= Lists.newArrayList();
    ...
    @ExcelField(title = "单图文多图文类型", dictType = "yes_no", align = 2, sort = 1)
    ...
    @ExcelField(title = "是否发布", dictType = "yes_no", align = 2, sort = 11)
    ...
    public List<WxMsgNewsArticle> getArticleList() {
        return articleList;
    }

    public void setArticleList(List<WxMsgNewsArticle> articleList) {
