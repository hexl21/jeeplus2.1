...
public class WxMediaVideoController extends BaseController {
    ...
    public String list(WxMediaFiles wxMediaFiles, Model model) {
        ...
        return "modules/weixin/video/wxMediaFilesList";
    }

    @RequestMapping(value = "select")
    public String select(WxMediaFiles wxMediaFiles, Model model) {
        model.addAttribute("wxMediaFiles", wxMediaFiles);
        return "modules/weixin/select/videoSelect";
    }
    ...
    public String form(WxMediaFiles wxMediaFiles, Model model) {
        model.addAttribute("wxMediaFiles", wxMediaFiles);
        return "modules/weixin/video/wxMediaFilesForm";
    }

    @RequestMapping(value = "look")
    public String look(WxMediaFiles wxMediaFiles, Model model) {
        model.addAttribute("wxMediaFiles", wxMediaFiles);
        return "modules/weixin/video/wxMediaFilesLook";
    }
