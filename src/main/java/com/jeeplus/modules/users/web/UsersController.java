 ...
 */
package com.jeeplus.modules.users.web;
...
import com.jeeplus.modules.users.entity.Users;
import com.jeeplus.modules.users.service.UsersService;
...
public class UsersController extends BaseController {
     ...
     * 查看，增加，编辑管理用户表单页面
     */
    @RequiresPermissions(value = {"users:users:view", "users:users:add", "users:users:edit"}, logical = Logical.OR)
     ...
     */
    @ResponseBody
    @RequiresPermissions(value = {"users:users:add", "users:users:edit"}, logical = Logical.OR)
     ...
     */
    @ResponseBody
    @RequiresPermissions("users:users:del")
     ...
     */
    @ResponseBody
    @RequiresPermissions("users:users:export")
     ...
     */
    @ResponseBody
    @RequiresPermissions("users:users:import")
